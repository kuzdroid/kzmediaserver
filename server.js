// Tek dosyalık Node.js sunucu (yalnızca yerleşik "http" modülü)
// İSTEK: "HTML kodu HİÇ DEĞİŞMEDEN" dönsün.
// Kullanım:
//   node server.js
// Ortam değişkeni: PORT (Render/Railway vb. için)
