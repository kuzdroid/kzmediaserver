...
// *** DİKKAT ***
// Aşağıdaki HTML, senin gönderdiğin içeriktir ve İÇERİĞE DOKUNMADIM.
// Sadece JS içinde string olarak tutmak için backtick (``) ile çevirdim.
const html = `html lang="tr">
<head>
<meta charset="utf-8"/>
...
const server = http.createServer((req, res) => {
  // Tüm isteklere aynı HTML’i döner
